// Terminal-Style Guide Replacement für window-manager.js
// Diese Funktion ersetzt die getGuideHTML() im WindowManager

// 1. Öffne window-manager.js
// 2. Suche die getGuideHTML() Funktion
// 3. Ersetze den Inhalt mit diesem Code:
...
// In window-manager.js die getGuideHTML() Funktion ersetzen:
// Ersetze die komplette Funktion mit:
//
// getGuideHTML() {
//     return TERMINAL_GUIDE_HTML;
// }

console.log('✅ Terminal Guide HTML für WindowManager bereit!');
console.log('📋 Kopiere den TERMINAL_GUIDE_HTML Inhalt und ersetze damit die getGuideHTML() Funktion');