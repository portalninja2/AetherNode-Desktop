/**
 * Terminal-Style Guide Integration
 * Ersetze die getGuideHTML() Funktion in window-manager.js
 */

// ANLEITUNG:
// 1. Öffne window-manager.js
// 2. Suche die getGuideHTML() Funktion (ca. Zeile 500+)
// 3. Ersetze den kompletten Inhalt zwischen den Backticks mit dem Code unten

const TERMINAL_GUIDE_HTML = `
<!DOCTYPE html>
<html lang="de">
<head>
    <meta charset="UTF-8">
...
console.log('🎯 ANLEITUNG ZUR INTEGRATION:');
console.log('1. Öffne window-manager.js');
console.log('2. Suche: getGuideHTML() {');
console.log('3. Ersetze den return `...` Teil mit: return TERMINAL_GUIDE_HTML;');
console.log('4. Kopiere TERMINAL_GUIDE_HTML Konstante an den Anfang der Datei');
console.log('✅ Fertig!');

// Exportiere für Copy-Paste
if (typeof module !== 'undefined') {
    module.exports = { TERMINAL_GUIDE_HTML };
}